...
<body>
   ...
   <div class="table-responsive">
        ...
        <tbody >
            @foreach ($resultados as $resultado)
                <tr >
                    ...
                    <td class="border-bottom-0">
                        {{ $resultado->Cantidad_Productos_Vendidos }}
                    </td>
                    <td class="border-bottom-0">
                        ${{ $resultado->Precio_Unitario }}
                    </td>
                    <td class="border-bottom-0">
                        ${{ $resultado->Monto_Total_Venta }}
                    </td>
                    <td class="border-bottom-0">
    ...
    <div class="text-end p-2">
        <p class="m-0 texto-grande"><strong>Total en venta en el dia:</strong> ${{ number_format($totalMonto, 2) }}</p>
