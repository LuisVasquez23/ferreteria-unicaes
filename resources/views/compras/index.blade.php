...
@foreach ($compras as $compra)
<div class="modal fade" id="detalleCompraModal{{ $compra->compra_id }}" tabindex="-1" role="dialog" aria-labelledby="detalleCompraModalLabel{{ $compra->compra_id }}" aria-hidden="true">
