                    ...
                    <tr>
                        ...
                        <td class="d-flex gap-1 justify-content-center">
                            @if ($filtro !== 'bloqueados')
                                        ...
                                        <form action="{{ route('periodos.bloquear', $periodo->periodo_id) }}"
                                            method="POST" id="block-form-{{ $periodo->periodo_id }}">
                                            @csrf
                                    ...
                                    @endif
                                    @if ($filtro === 'bloqueados')
                                    <form action="{{ route('periodos.unblock', $periodo->periodo_id) }}"
                                        method="POST" id="unblock-form-{{ $periodo->periodo_id }}">
                                        @csrf
                                        @method('PUT') <!-- Agrega esta línea para indicar que es una solicitud PUT -->
