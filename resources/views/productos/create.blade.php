    ...
    <div class="card-body">
        ...
        >
            ...
            <div class="form-group col-md-6">
                ...
                <input
                    type="text"
                    class="form-control {{ $errors->has('nombre_opcion') ? 'is-invalid' : '' }}"
                    name="nombre_opcion"
                    id="nombre_opcion"
                    required
                />
            ...
            <div class="form-group col-md-6">
                ...
                <input
                    type="text"
                    class="form-control {{ $errors->has('descripcion_opcion') ? 'is-invalid' : '' }}"
            ...
            <div class="form-group col-md-6 mt-2">
                ...
                <input
                    type="file"
                    class="form-control {{ $errors->has('imagenProducto') ? 'is-invalid' : '' }}"
                    name="imagenProducto"
                    id="imagenProducto"
                    accept="image/*"
                    required
            ...
            <div class="col-md-6 mt-2">
                <div class="form-group">
                    ...
                    >
                        ...
                        @else @foreach ($proveedores as $usuario_id => $nombres)
            ...
            <div class="col-md-6 mt-2">
                <div class="form-group">
                    ...
                    >
                        ...
                        @else @foreach ($categorias as $categoria_id =>
                        $categoria)
            ...
            <div class="col-md-6 mt-2">
                <div class="form-group">
                    ...
                    >
                        ...
                        @else @foreach ($estantes as $estante_id =>
                        $nombreEstante)
            ...
            <div class="col-md-6 mt-2">
                <div class="form-group">
                    ...
                    >
                        ...
                        @else @foreach ($unidades as $unidad_medida_id =>
                        $nombreUnidad)
            ...
            <div class="col-md-6 mt-2">
                <div class="form-group">
                    ...
                    >
                        ...
                        @else @foreach ($periodos as $periodo_id => $fecha)
            ...
            <div class="col-md-6 mt-2">
                <div class="form-group">
                    <label for="fechaVencimientoProducto"
                ...
                <div class="form-group mt-2">
                    <input
                        type="checkbox"
                        name="activarFechaVencimiento"
                        id="activarFechaVencimiento"
                        class="form-check-input"
                    />
                    <label
                        for="activarFechaVencimiento"
            ...
            <div class="form-group col-md-12 mt-3">
                ...
                <a href="{{ route('productos') }}" class="btn btn-dark"
                    >Regresar</a
                >
            </div>
        </form>
